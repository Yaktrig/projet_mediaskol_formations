 ...
 * <p>
 * Cette entité contient les informations de base d'un département, telles que
 * son numéro, son nom, sa région,
 * sa couleur hexadécimale.
 * *
 * </p>
 * <p>
 * Pour le moment, nous avons besoin de colorer que les départements de la
 * Bretagne, mais dans le futur,
 * cette application pourrait être amenée à être utilisée dans toute la France
 * (ou besoin pour le distanciel).
 * </p>
 * <p>
 * Ajout du @Data de Lombok pour avoir les getter et les setter, toString,
 * equals, hashCode
 * </p>
 *
 * @author Mélissa
...
public class Departement {
     ...
     * <p>
     * Ce champ n'est pas obligatoire, il est réservé pour les départements de la
     * Bretagne.
     * </p>
     */
