...
@Component({
  ...
  templateUrl: './formation-ajouter.html',
  styleUrls: ['./formation-ajouter.css']
})
export class FormationAjouter implements OnInit {
...
// Accessibilité de l’erreur dans template
   ...
   * - Valide la saisie
   * - Construit un DTO pour la création (SessionFopReqDTO)
