...
export const StatutFormateurDetails: StatutFormateur = {
  label: string, color: string
} = {
  [StatutFormateur.SESSION_FORMATEUR_ATTENTE_PRESENCE]:{
    label:'En attente de confirmation de présence',
    color:'#FF7F00',
  },
[StatutFormateur.SESSION_FORMATEUR_PRESENCE_CONFIRMEE]:{
    label:'Présence du formateur confirmée',
  color:'#13FF06',
},
 [StatutFormateur.SESSION_FORMATEUR_PRESENCE_ANNULEE]:{
    label:'Annulation par le formateur',
   color:'#FF2F05',
 },
  [StatutFormateur.SESSION_FORMATEUR_EN_ATTENTE_PAIEMENT]:{
    label:'"Formateur en attente de paiement',
    color:'#FFFFFF',
  },
  [StatutFormateur.SESSION_FORMATEUR_SALARIE]:{
    label:'Formateur salarié',
    color:'pink-20',
  },
  [StatutFormateur.SESSION_FORMATEUR_AE_FACTURE_REGLEE]:{
